...
package com.google.samples.apps.nowinandroid.screenshottest
...
import com.google.samples.apps.nowinandroid.core.ui.screenshottest.NamedPreviewParameterProvider
...
class PreviewTests {
    ...
    private object ComposablePreviewProvider : TestParameterValuesProvider {
        ...
        private const val APPLICATION_PACKAGE = "com.google.samples.apps.nowinandroid"
...
private fun Method.toComposablePreview(
    ...
    return object : ComposablePreview by proxy {
        override val renderingMode = getRenderingMode()
...
private fun Method.getRenderingMode(): RenderingMode {
    val generateScreenshotTestAnnotation =
        annotations.find { it is ScreenshotTestParameters } as ScreenshotTestParameters?
    return when (generateScreenshotTestAnnotation?.renderingMode) {
        TestRenderingMode.NORMAL -> RenderingMode.NORMAL
        TestRenderingMode.SHRINK -> RenderingMode.SHRINK
        else -> RenderingMode.SHRINK
    }
}
